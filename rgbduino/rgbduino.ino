...
// generated at https://srgbmods.net
	...
	#error ONLY Raspberry Pi Pico and third-party variants using RP2040 chip are supported!
#endif
...
const int ledsPerPin[numPins] = { 20,20,20,20,20,20,20,20 };
const int offsetPerPin[numPins] = { 20,40,60,80,100,120,140,160 };
const int totalLedCount = 160;
...
void Setup_SRGBmodsLCv1()
{
	...
	TinyUSBDevice.setProductDescriptor("LED Controller v1");
...
void processUSBpacket()
{
	...
	else if(!usbPacket[0] && !usbPacket[1] && !usbPacket[2] && usbPacket[3] == 0xBB)
	{
		...
		EEPROM.write(eeprom_HWL_color_b, HWL_singleColor[2]);
